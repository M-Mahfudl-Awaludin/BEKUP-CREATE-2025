...
class CeksantapTextStyles {
  static const TextStyle _commonStyle = TextStyle(
    fontFamily: 'Rubik',
  );

  static const TextStyle _swashStyle = TextStyle(
  ...
  static TextStyle titleLarge = _swashStyle.copyWith(
    fontSize: 22,
    fontWeight: FontWeight.w500,
    height: 1.2,
    letterSpacing: 1.2,
  ...
  static TextStyle titleMedium = _swashStyle.copyWith(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    height: 1.2,
    letterSpacing: 1.2,
  ...
  static TextStyle titleSmall = _swashStyle.copyWith(
    fontSize: 14,
